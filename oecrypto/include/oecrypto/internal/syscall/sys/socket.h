...
#include <oecrypto/internal/syscall/sys/uio.h>
...
#include <oecrypto/internal/syscall/sys/bits/sockaddr.h>
#undef __OE_SOCKADDR

#define __OE_SOCKADDR_STORAGE oe_sockaddr_storage
#include <oecrypto/internal/syscall/sys/bits/sockaddr_storage.h>
#undef __OE_SOCKADDR_STORAGE

#define __OE_IOVEC oe_iovec
#define __OE_MSGHDR oe_msghdr
#include <oecrypto/internal/syscall/sys/bits/msghdr.h>
#undef __OE_IOVEC
#undef __OE_MSGHDR
